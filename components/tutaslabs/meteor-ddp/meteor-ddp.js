...
var Watch = function(coll,dispatcher) {
    ...
    ddp.watch(this.coll, function(chg,mess){
        this.dispatch.emit(this.coll, {'chg': chg, 'mess': mess})
...
FamousFramework.scene('tutaslabs:meteor-ddp', {

    events: {
        '$public': {
            /**
             * The URi to use for ddp connection.
             * payload:uri  payload:watch {w1,w2,w3}
             */
                ...
                if (!ddp || !ddp.connected) {
                    ...
                    try {
                        ...
                        ddp.connect().done(function () {
                            ...
                            if ($payload.debug) console.log('connected');
